...
namespace BusinessLogic
{
    public class DepartmentLogic : ILogic<Department>
    {
        ...
        {
            String query = "select Department.Name as 'Department', Department.DepartmentID, Staff.Name as 'Manager' from Department,Staff where Department.ManagerID=Staff.StaffID and Department.Name like @Name+'%' and Department.AccountID=@AccountID order by Department.Name";
