<%@ Page Title="" Language="C#" MasterPageFile="~/HotelAdmin.master" AutoEventWireup="true" CodeFile="searchdepartment.aspx.cs" Inherits="searchdepartment" %>
        ...
        <div class="widget-body form">
            <div class="form-horizontal">
                <div class="control-group">
                    ...
                    <div class="controls">
                        <asp:TextBox ID="txtName" runat="server" CssClass="span6  tooltips" data-trigger="hover" data-original-title="Enter department name to search for."></asp:TextBox>
