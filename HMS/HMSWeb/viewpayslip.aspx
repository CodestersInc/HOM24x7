                                    ...
                                    <asp:Repeater ID="staffInfoRepeater" runat="server">
                                        <ItemTemplate>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:Label ID="lblWorkingDays" runat="server"><b></asp:Label></td>
                                                <td>
                                                    <label class="boldText">Days Payable</label></td>
                                                <td>
                                                    <asp:Label ID="lblDaysPayable" runat="server"><b><%# Eval("DaysPayable") %></asp:Label></td>
                                            </tr>
                                        </ItemTemplate>
                                    </asp:Repeater>
                                </table>
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td style="text-align: right">
                                                    <asp:Label ID="lblBasicSalary" runat="server"><b><%# Eval("Salary") %></asp:Label></td>                                                    
