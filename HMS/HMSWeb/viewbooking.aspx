...
<asp:Content ID="Content2" ContentPlaceHolderID="bodyContentPlaceHolder" runat="Server">
    ...
    <div class="container-fluid">
        ...
        <div class="row-fluid">
            <div class="span12">
                <h3 class="page-title">View a Booking</h3>
                <ul class="breadcrumb">
                    <li>
                        ...
                        <div>
                            <div class="form-horizontal">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <asp:TextBox ID="txtStaffRemarks" TextMode="MultiLine" runat="server" CssClass="span4 popovers" data-trigger="hover" data-content="Enter staff remarks." data-original-title="Popover header"></asp:TextBox>
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <asp:TextBox ID="txtCustomerRemarks" TextMode="MultiLine" runat="server" CssClass="span4 popovers" data-trigger="hover" data-content="Enter customer remarks." data-original-title="Popover header"></asp:TextBox>
                                    </div>
                                </div>
