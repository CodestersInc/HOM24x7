                            ...
                            <div class="form-horizontal">
                                <asp:PlaceHolder ID="NoRoomPlaceHolder" runat="server" Visible="false">
                                    <div class="control-group">
                                        <div class="controls">
                                            <div class="alert">
                                                <label>Please create a Room before you can genarate any Bookings</label>
                                ...
                                <asp:PlaceHolder ID="CreateBookingPlaceHolder" runat="server">
                                    ...
                                    <asp:PlaceHolder ID="ExtraInfoPlaceHolder" runat="server" Visible="true">
                                        ...
                                        <div class="control-group">
                                            <label class="control-label">Acctual check out Date</label>
                                            <div class="controls">
                                                <div class="input-append date date-picker" data-date="12-02-2012" data-date-format="dd-mm-yyyy" data-date-viewmode="years">
                                                    <asp:TextBox ID="txtCheckoutDate" runat="server" CssClass="span6 non-editable" Text="dd-mm-yyyy"></asp:TextBox>
                                                    <span class="add-on"><i class="icon-calendar"></i></span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <asp:DropDownList ID="ddlStatus" runat="server" CssClass="span4" data-placeholder="Select/update the status of the booking" TabIndex="1">
                                                    ...
                                                    <asp:ListItem Value="Chechked in">Checked in</asp:ListItem>
                                                    <asp:ListItem Value="Chechked out">Checked out</asp:ListItem>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <div class="input-prepend input-append">
                                                    ...
                                                    <%--CssClass="alert alert-error"--%><%-- we need to fix the bug for showing the message--%>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <asp:TextBox ID="txtCustomer" runat="server" CssClass="span4 popovers" data-trigger="hover" data-content="Enter the Customer." data-original-title="Popover header"></asp:TextBox>
                                                <asp:Button ID="btnCustomerSearch" runat="server" CssClass="btn" Text="Search" OnClick="btnCustomerSearch_Click" />
                                                <asp:RequiredFieldValidator ID="NameRequiredFieldValidator" ControlToValidate="txtCustomer" Display="Dynamic" runat="server" ValidationGroup="First" ErrorMessage="Please enter Customer" CssClass="alert alert-error" />
                                                <b>OR</b>
                                                <asp:Button ID="btnCustomerCreate" CssClass="btn" runat="server" OnClick="btnCustomerCreate_Click" Text="Eneter a New Customer Record" />
                                            </div>
                                        </div>

                                        <!--CUSTOMER CREATE START-->
                                        <asp:PlaceHolder ID="PlaceHolderCreateCustomer" runat="server" Visible="false">
                                            <div class="row-fluid">
                                                <div class="span12">
                                                    <!-- BEGIN SAMPLE FORM widget-->
                                                    <div class="widget">
                                                        <div class="widget-title">
                                                            <h4><i class="icon-reorder"></i>Customer Detail</h4>
                                                            <span class="tools">
                                                                <a href="javascript:;" class="icon-chevron-down"></a>
                                                                <a href="javascript:;" class="icon-remove"></a>
                                                            </span>
                                                            ...
                                                            <div>
                                                                <div class="form-horizontal">
                                                                    ...
                                                                    <div class="control-group">
                                                                        ...
                                                                        <div class="controls">
                                                                            <asp:TextBox ID="txtCustomerName" runat="server" CssClass="span4"></asp:TextBox>
                                                                            <asp:RequiredFieldValidator ControlToValidate="txtCustomerName" ID="CustomerNameRequiredFieldValidator" runat="server" ErrorMessage="Please enter full name of customer" Display="Dynamic" ValidationGroup="Second" CssClass="alert alert-error"></asp:RequiredFieldValidator>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="control-group">
                                                                        <div class="controls">
                                                                            <asp:Button ID="btnCustomerSubmit" ValidationGroup="Second" CssClass="btn btn-success" runat="server" Text="Create" OnClick="btnCustomerSubmit_Click" />
                                                                            <asp:Button ID="btnCustomerCancel" CssClass="btn btn-danger" runat="server" Text="Cancle" OnClick="btnCustomerCancel_Click" />
                                                                        </div>
                                                                    </div>
                                        ...
                                        <asp:PlaceHolder ID="PlaceHolderCustomerSearchResult" runat="server" Visible="false">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <div class="input-prepend input-append">
                                                    ...
                                                    <asp:RequiredFieldValidator ControlToValidate="txtRoomRates" Display="Dynamic" ID="RequiredFieldValidator1" runat="server" ErrorMessage="Please enter salary of the Staff" ValidationGroup="First"></asp:RequiredFieldValidator>
                                                    <%--CssClass="alert alert-error"--%><%-- we need to fix the bug for showing the message--%>
